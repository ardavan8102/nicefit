...
class $AssetsImageGen {
  ...
  /// File path: assets/image/body_builder_man.png
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/letter.svg
  String get letter => 'assets/svg/letter.svg';

  /// List of all assets
  List<String> get values => [heart, notification, wallet, letter];
}
